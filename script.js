...
function renderCheckoutPage(){
  ...
  if(form){
    form.addEventListener('submit', (e) => {
      ...
      const shipPay = document.getElementById('shipPay').value;
...
function renderInvoicePage(){
  ...
  // Populate header
  orderDateEl.textContent = orderData.orderDate;
  orderIdEl.textContent = orderData.orderId;

  // Populate items table
  invoiceItemsEl.innerHTML = '';
  for(const [id, qty] of Object.entries(orderData.items)){
  ...
  // Populate summary
  invoiceSubtotalEl.textContent = money(orderData.totals.subtotal);
  invoiceTaxEl.textContent = money(orderData.totals.tax);
  invoiceTotalEl.textContent = money(orderData.totals.total);

  // Populate shipping
  shipNameEl.textContent = orderData.shipping.name;
  shipAddressEl.textContent = orderData.shipping.address;
